...
class detail_Activity(tk.Frame):
    def __init__(self, parent, controller):
        ...
        Label(data_header_frame, text='유체유량', font=setFont(), fg='white', bg='#2f323b', width=8).grid(row=3, column=6)
        ...
        Label(data_header_frame, text='유체유량', font=setFont(), fg='white', bg='#2f323b', width=8).grid(row=12, column=6)
        ...
        Label(data_header_frame, text='유체유량', font=setFont(), fg='white', bg='#2f323b', width=8).grid(row=17, column=6)
        ...
        Label(data_header_frame, text='유체유량', font=setFont(), fg='white', bg='#2f323b', width=8).grid(row=20, column=6)
        ...
        Label(data_header_frame, text='유체유량', font=setFont(), fg='white', bg='#2f323b', width=8).grid(row=28, column=6)
