...
class main_Activity(tk.Frame):
    def __init__(self, parent, controller):
        ...
        logo_label = Label(left_frame, image=self.logo_image, highlightbackground="#2F323B", activebackground='#2F323B', bd=0, bg='#2F323B')
        ...
        main_menu = Button(left_frame, image=self.main_image, highlightbackground='#2F323B', activebackground='#2F323B', bd=0, bg='#2F323B', command=lambda: controller.show_frame('main_Activity'))
        main_menu.pack(pady=(40, 20))

        control_menu = Button(left_frame, image=self.control_image, highlightbackground='#2F323B', activebackground='#2F323B', bd=0, bg='#2F323B', command=lambda: controller.show_frame('control_Activity'))
        control_menu.pack(pady=20)

        detail_menu = Button(left_frame, image=self.main_image, highlightbackground='#2F323B', activebackground='#2F323B', bd=0, bg='#2F323B', command=lambda: controller.show_frame('control_Activity'))
        detail_menu.pack(pady=20)

        setting_menu = Button(left_frame, image=self.setting_image, highlightbackground='#2F323B', activebackground='#2F323B', bd=0, bg='#2F323B', command=lambda: controller.show_frame('setting_Activity'))
        setting_menu.pack(pady=20)

        self.gps_image = tk.PhotoImage(file='images/gps.png')
        gps_menu = Label(left_frame, image=self.gps_image, highlightbackground='#2F323B', activebackground='#2F323B', bd=0, bg='#2F323B')
        gps_menu.pack(pady=(950, 15))

        weather_frame = Frame(left_frame, bg='#2F323B')
        weather_frame.pack(pady=(0, 10))

        weather_menu = Label(weather_frame, text='날 씨', highlightbackground='#2F323B', activebackground='#2F323B', bd=0, bg='#2F323B', font=('arial', 16, 'bold'), fg='white')
        weather_menu.pack(side=LEFT, padx=(0, 10))

        main_Activity.weather_label = Label(weather_frame, text='맑 음', highlightbackground='#2F323B', activebackground='#2F323B', bd=0, bg='#2F323B', font=('arial', 16), fg='white')
        main_Activity.weather_label.pack(side=LEFT)

        temperature_frame = Frame(left_frame, bg='#2F323B')
        temperature_frame.pack()

        temperature_menu = Label(temperature_frame, text='기 온', highlightbackground='#2F323B', activebackground='#2F323B', bd=0, bg='#2F323B', font=('arial', 16, 'bold'), fg='white')
        temperature_menu.pack(side=LEFT, padx=(0, 10))

        main_Activity.temperature_label = Label(temperature_frame, text='32', highlightbackground='#2F323B', activebackground='#2F323B', bd=0, bg='#2F323B', font=('arial', 16), fg='white')
        main_Activity.temperature_label.pack(side=LEFT)

        temperature_unit = Label(temperature_frame, text=' ℃', highlightbackground='#2F323B', activebackground='#2F323B', bd=0, bg='#2F323B', font=('arial', 16, 'bold'), fg='white')
        temperature_unit.pack(side=LEFT)

        main_Activity.time_label1 = Label(left_frame, text='-', highlightbackground='#2F323B', activebackground='#2F323B', bd=0, bg='#2F323B', font=('arial', 18, 'bold'), fg='white')
        main_Activity.time_label1.pack(pady=(150, 10))

        main_Activity.time_label2 = Label(left_frame, text='-', highlightbackground='#2F323B', activebackground='#2F323B', bd=0, bg='#2F323B', font=('arial', 18, 'bold'), fg='#96c63e')
        main_Activity.time_label2.pack()

        system_exit_btn = Button(left_frame, text='', highlightbackground='#2F323B', activebackground='#2F323B', bd=0, bg='#2F323B', fg='#2F323B', command=lambda: self.sys_exit())
        ...
        # 데이터 캔버스 그리기
        main_Activity.top_canvas = Canvas(top_frame, bg='#2f323b', highlightbackground='#2f323b', width=870, height=200)
        main_Activity.top_canvas.pack(padx=15, fill=X)
        ...
        # 라인선 그리기
        main_Activity.main_canvas = Canvas(center_frame, bg='#2f323b', highlightbackground='#2f323b', width=870, height=1200)
        ...
        # 설비 연결선 라벨
        main_Activity.line1 = main_Activity.main_canvas.create_line(465-x, 190, 685-x, 190, fill='white', width=5, arrow=LAST)    # PVT-팬
        main_Activity.line2 = main_Activity.main_canvas.create_line(732-x, 242, 641-x, 365, fill='white', width=5, arrow=LAST)  # 팬-열교환기
        main_Activity.line3 = main_Activity.main_canvas.create_line(538-x, 400, 363-x, 400, fill='white', width=5, arrow=LAST)    # 열교환기-댐퍼
        main_Activity.line4 = main_Activity.main_canvas.create_line(186-x, 556, 270-x, 436, fill='#96c63e', width=5, arrow=LAST)    # 외기-댐퍼
        main_Activity.line5 = main_Activity.main_canvas.create_line(342-x, 338, 417-x, 235, fill='white', width=5, arrow=LAST)   # 댐퍼-PVT
        main_Activity.line6 = main_Activity.main_canvas.create_line(583-x, 443, 490-x, 570, fill='white', width=5, arrow=LAST)    # 열교환기-버퍼탱크
        main_Activity.line7 = main_Activity.main_canvas.create_line(484-x, 518, 552-x, 425, fill='white', width=5, arrow=LAST)    # 버퍼탱크-열교환기
        main_Activity.line8 = main_Activity.main_canvas.create_line(513-x, 590, 688-x, 590, fill='white', width=5, arrow=LAST)    # 버퍼탱크-이중코일
        main_Activity.line9 = main_Activity.main_canvas.create_line(692-x, 615, 513-x, 615, fill='white', width=5, arrow=LAST)    # 이중코일-버퍼탱크
        main_Activity.line11 = main_Activity.main_canvas.create_line(701-x, 625, 647-x, 697, fill='white', width=5, arrow=LAST)   # 이중코일-히트펌프
        main_Activity.line12 = main_Activity.main_canvas.create_line(654-x, 744, 729-x, 642, fill='white', width=5, arrow=LAST)   # 히트펌프-이중코일
        main_Activity.line13 = main_Activity.main_canvas.create_line(551-x, 825, 485-x, 916, fill='white', width=5, arrow=LAST)  # 히트펌프-저장탱크
        main_Activity.line14 = main_Activity.main_canvas.create_line(489-x, 967, 582-x, 843, fill='white', width=5, arrow=LAST)  # 저장탱크-히트펌프
        main_Activity.line15 = main_Activity.main_canvas.create_line(538-x, 788, 363-x, 788, fill='white', width=5, arrow=LAST)  # 히트펌프-온수탱크
        main_Activity.line16 = main_Activity.main_canvas.create_line(363-x, 813, 538-x, 813, fill='white', width=5, arrow=LAST)  # 온수탱크-히트펌프
        main_Activity.line17 = main_Activity.main_canvas.create_line(513-x, 987, 688-x, 987, fill='white', width=5, arrow=LAST)  # 저장탱크-FCU
        main_Activity.line18 = main_Activity.main_canvas.create_line(688-x, 1017, 513-x, 1017, fill='white', width=5, arrow=LAST)  # FCU-저장탱크
        ...
        main_Activity.bipvt_connect_value = Label(main_Activity.main_canvas, text='●', font=('arial', 30, 'bold'), fg='red', bg='#2f323b')
        ...
        main_Activity.heatpump_connect_value = Label(main_Activity.main_canvas, text='●', font=('arial', 30, 'bold'), fg='red', bg='#2f323b')
        main_Activity.heatpump_connect_value.place(x=250, y=0)

        fcu_connect_label = Label(main_Activity.main_canvas, text='FCU통신', font=('arial', 15, 'bold'), fg='white', bg='#2f323b')
        fcu_connect_label.place(x=290, y=13)

        main_Activity.fcu_connect_value = Label(main_Activity.main_canvas, text='●', font=('arial', 30, 'bold'), fg='red', bg='#2f323b')
