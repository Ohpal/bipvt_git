...
class put_summer_heatpump_value(tkinter.simpledialog.Dialog):
    def body(self, master):
        def clear():
            self.e1.delete(0, END)
            return
        ...
        def ok_pressed():
            ...
            self.master.summer_heatpump_value.delete(0, END)
            self.master.summer_heatpump_value.insert("end", self.pin)
            self.destroy()
            self.master.focus()
...
class put_winter_heatpump_value(tkinter.simpledialog.Dialog):
    def body(self, master):
        def clear():
            self.e1.delete(0, END)
            return
        ...
        def ok_pressed():
            ...
            self.master.winter_heatpump_value.delete(0, END)
            self.master.winter_heatpump_value.insert("end", self.pin)
            self.destroy()
            self.master.focus()
